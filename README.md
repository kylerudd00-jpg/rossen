...
- `OPENAI_STORY_COUNT`: target number of verified story cards to return, default `24`
- `GEMINI_STORY_COUNT`: target number of Gemini-researched story cards to return, default `24`
